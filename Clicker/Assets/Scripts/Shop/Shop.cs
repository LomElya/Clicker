...
public class Shop : MonoBehaviour
{
    ...
    [Inject]
    public void Init(IDataProvider dataProvider, Wallet wallet, Income income, Level level, ClickableItem clickable, ShopContent shopContent,
